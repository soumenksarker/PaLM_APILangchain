...
def create_conversational_chain(docsearch):
    load_dotenv()
    prompt_template  = """
    Based on the following piece of context and searching from other sources update if needed to answer the question. Translate in Bangla language using Google Translate if the user asks for translation. Please provide a detailed response for each of the questions.
    
    {context}
    
    Question: {question}
    
    Answer in English or Bangla"""
