...
def main():
    ...
    st.sidebar.write("To extract info from multiple URL's, remove the previous one and paste a new URL each time! Info from new URL will be accommodated to the system automatically!")
    urls = []
    for i in range(1):
