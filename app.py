...
def main():
    ...
    st.sidebar.write("For information extraction from multiple url's, just paste a single url and press the Process Urls each time! Info from new URL will be accomodated to the system automatically!")
    urls = []
    for i in range(1):
    ...
    if uploaded_files or process_url_clicked:
        text = []
